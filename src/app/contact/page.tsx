...
const socials = [
  ...
  {
    name: "GitHub",
    href: "https://github.com/Luan-Knachak4",
    color: "#00E5FF",
    external: true,
    icon: (
      <svg
...
function Field({
  ...
  return (
    <div className={styles.fieldWrap}>
      ...
      {isTextarea ? (
        <textarea {...base} rows={5} />
      ) : (
        <input {...base} type={type} />
      )}
      {/* Character counter only on message */}
      {isTextarea && (
        <div className={styles.charCount}>
          <span
            className={value.length > MESSAGE_MAX * 0.9 ? styles.charWarn : ""}
          >
            {value.length}
          </span>
          /{MESSAGE_MAX}
...
export default function Contact() {
  ...
  function handleChange(
    ...
    if (touched[name as keyof FormState]) {
      setErrors((p) => ({
        ...p,
        [name]: validate({ ...form, [name]: value })[name as keyof Errors],
      }));
    }
  }
  function handleBlur(
        ...
        <div className={`container ${styles.heroInner}`}>
          ...
          <div className={styles.heroContent}>
            ...
            <div className={styles.heroLeft}>
              ...
              >
                Estou em busca da primeira oportunidade profissional em
                Back-End. Preencha o formulário ou use um dos canais diretos
                abaixo — respondo rápido!
              </motion.p>
            ...
            <div className={styles.infoCol}>
              ...
              >
                ...
                <div className={styles.terminalBody}>
                  <p>
                    <span className={styles.tc}>$</span> status
                  </p>
                  <p className={styles.td}>▸ Disponível para novos projetos</p>
                  <p>
                    <span className={styles.tc}>$</span> stack --primary
                  </p>
                  <p className={styles.td}>▸ Python · Java · Crystal · SQL</p>
                  <p>
                    <span className={styles.tc}>$</span> contact --send
                  </p>
                  ...
                  {status === "sent" ? (
                    ...
                    >
                      ...
                      <p className={styles.successText}>
                        ...
                        <strong>{form.name.split(" ")[0] || "amigo"}</strong>!
                        <br />
                    ...
                    >
                      ...
                      <p className={styles.formPrivacy}>
                        🔒 Seus dados são usados apenas para responder sua
                        mensagem.
                      </p>
                    </motion.form>
                  )}
